...
| `TELEGRAM_WEBHOOK_BASE_URL` | 部署後的 Worker base URL，例如 `https://hko-weather-telegram-bot.<subdomain>.workers.dev` |
...
6. 呼叫 Worker 內置 `/telegram/set-webhook` endpoint，由 Worker 自己設定 Telegram webhook
